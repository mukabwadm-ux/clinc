  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-dark text-white">
        ...
        {/* ── Industrial Coatings ── */}
        <section id="industrial" className="py-14 sm:py-20 lg:py-28 relative overflow-hidden">
          <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, #0a1628, #07111F)' }} />
          <div className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(245,166,35,0.06) 0%, transparent 70%)', filter: 'blur(60px)' }} />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {industrialProducts.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
                {industrialProducts.map(p => <ProductCard key={p.id} {...p} />)}
              </div>
            ) : (
              <div className="rounded-2xl border border-white/[0.06] py-14 text-center">
